...
public enum VanillaArmorMaterial {
    ...
    VanillaArmorMaterial(Material boots, Material legs, Material chest, Material head) {
        if (boots != null) {
            ...
            VanillaArmorPiece vap = new VanillaArmorPiece(null);
    ...
    public static VanillaArmorPiece get(Material material) {
        ...
        for(VanillaArmorMaterial type : VanillaArmorMaterial.values()) {
    ...
    public class VanillaArmorPiece {
        ...
        public VanillaArmorMaterial getType() {
