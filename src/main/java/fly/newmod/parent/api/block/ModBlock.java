package fly.newmod.parent.api.block;

import fly.newmod.parent.NewMod;
import fly.newmod.parent.api.block.data.ModBlockData;
import fly.newmod.parent.api.block.type.ModBlockType;
import fly.newmod.parent.api.event.block.ModBlockBreakEvent;
 ...
 *
 * @see fly.newmod.parent.api.item.ItemManager#deserializeModItemStack
 */
